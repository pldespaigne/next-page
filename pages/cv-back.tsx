    ...
    <main className={'flex bg-slate-900 justify-center ' + inter.className}>
      <section className="relative flex flex-col bg-slate-700 px-10 py-12" style={{ width: 310, maxWidth: 310 }}>
        ...
        <div className="mt-6">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <p className="text-slate-300 border border-slate-400 px-2.5 py-1 rounded-full">Typescript</p>
            <p className="text-slate-300 border border-slate-400 px-2.5 py-1 rounded-full">NodeJS</p>
            <p className="text-slate-300 border border-slate-400 px-2.5 py-1 rounded-full">Ethers</p>
            <p className="text-slate-300 border border-slate-400 px-2.5 py-1 rounded-full">EVM</p>
            <p className="text-slate-300 border border-slate-400 px-2.5 py-1 rounded-full">ExpressJS</p>
      ...
      <section className="flex flex-col bg-slate-50 min-h-screen max-w-lg px-8 py-16 text-slate-900">
        <div>
          ...
          <h2 className="text-2xl font-semibold mt-4 font-mono italic flex items-center gap-4"><TerminalSquareIcon/><span>Backend Web3 developer</span></h2>
          <p className="text-justify text-sm">
            I&apos;m a <span className="font-semibold text-slate-600">full-stack</span> web3 developer, looking to transition to a <span className="font-semibold text-slate-600">backend</span> role.
            I&apos;m used to async and remote work.
            I have contributed to well known projects like&nbsp;
